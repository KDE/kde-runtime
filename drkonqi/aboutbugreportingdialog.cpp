        ...
        KDialog(parent)
{
    ...
    QString text =
        ...
        QString("<p>%1<a href=\"%2\">%2</a></p><p>%3</p>").arg(
            Qt::escape(i18nc("@info/plain","This page will generate the trace of the crash. This information is "
            ...
            Qt::escape(i18nc("@info/plain","Once you get an useful trace (or if you don't want to install the "
        ...
        QString("<p>%1</p><p>%2</p>").arg(
            ...
            Qt::escape(i18nc("@info/plain","If you can describe the crash context (the details of what were you "
        ...
        QString("<p>%1</p><p>%2</p><p>%3</p>").arg(
            Qt::escape(i18nc("@info/plain","Using the usefulness of the crash information gathered previously , "
            ...
            Qt::escape(i18nc("@info/plain","If the crash is worth reporting, and the application is supported in "
                            "the KDE bug tracking system, you can click <interface>Next</interface>. However if it's not "
                            "supported you will need to contact the maintainer of the application.")),
            Qt::escape(i18nc("@info/plain","If the crash is not worth reporting, you can still manually report "
        ...
        QString("<p>%1<a href=\"%2\">%2</a></p><p>%3</p><p>%4</p>").arg(
            Qt::escape(i18nc("@info/plain","As we may need to contact you in the future to ask further information "
        ...
        QString("<p>%1</p><p>%2</p><p>%3</p><p>%4</p>").arg(
            ...
            Qt::escape(i18nc("@info/plain","This page will search at the bug report database for similar crashes "
            ...
            Qt::escape(i18nc("@info/plain","If the listed possible duplicates aren't enough (or you didn't found a "
