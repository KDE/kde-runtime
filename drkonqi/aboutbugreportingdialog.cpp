    ...
    KDialog(parent)
{
    ...
    QString( "<a name=\"Begin\" /><h1>%1</h1>").arg( Qt::escape( i18n("Information about bug reporting") ) ) +
    ...
    QString( "<p>%1</p><p>%2</p>" ).arg( 
        Qt::escape( i18n("In this page you need to answer some questions about the crash context and your will to help the developers in the future if it's needed.") ), 
        Qt::escape( i18n("If you can describe the crash context (the details of what were you doing when the application crashed: you can mention: Documents that you were using (or its type/format), actions you were taking in the application and the whole system, web sites you were browsing, another strange things you notices after of before the crash, and so on.")) ) +
