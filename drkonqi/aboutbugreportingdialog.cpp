...
want to, "
        ...
        QString("<p>%1</p>").arg(
            Qt::escape(i18nc("@info/plain","This assistant will guide you through the crash reporting process of "
                            ...
                            "to the bug report must be in ENGLISH as KDE is international "
                            "software."))) +
...
is information "
                            "tells the developers where the application crashed. If the crash "
                            "information isn't detailed enough, you may need to install some "
                            "packages and reload it. You can find more information about backtraces
"
                            "and what they mean and how they are useful on ")),
            QString(TECHBASE_HOWTO_DOC),
            Qt::escape(i18nc("@info/plain","Once you get a useful trace (or if you don't want to "
...
previously, "
            ...
            Qt::escape(i18nc("@info/plain","If the crash is worth reporting, and the application is supported in "
                            "the KDE bug tracking system, you can click
...
similar"
                            ...
                            "bug report information so you can check if the situations are similar
and "
                            "you can tentatively mark your crash as a duplicate of that report.")),
            Qt::escape(i18nc("@info/plain","If the listed possible duplicates are not enough, or "
                            "you did not find a similar report, then you can force
the search of more bug reports (only if "
                            "the date range is not reached)")),
            Qt::escape(i18nc("@info/plain","Don't worry if you can't find a similar bug report or you don't know "
