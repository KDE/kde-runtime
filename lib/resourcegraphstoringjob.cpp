...
Nepomuk::ResourceGraphStoringJob::ResourceGraphStoringJob(const Nepomuk::SimpleResourceGraph& graph, const KComponentData& component)
    : KJob(0)
{
